    ...
    array set block_cmd {
        ...
        v_hdmi_tx_ss            {-type ip -vlnv xilinx.com:ip:v_hdmi_tx_ss:3.0}
        v_hdmi_rx_ss            {-type ip -vlnv xilinx.com:ip:v_hdmi_rx_ss:3.0}
        ...
        vid_phy_controller      {-type ip -vlnv xilinx.com:ip:vid_phy_controller:2.1}
